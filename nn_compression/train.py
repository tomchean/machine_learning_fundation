...
# get dataloader
train_dataloader = get_dataloader('training', batch_size=128)
valid_dataloader = get_dataloader('validation', batch_size=128)
...
for epoch in range(200):
    ...
    if valid_acc > now_best_acc:
        ...
        torch.save(student_net.state_dict(), './best.bin')

    print('epoch {:>3d}: train loss: {:6.4f}, acc {:6.4f} valid loss: {:6.4f}, acc {:6.4f}'.format(
        epoch, train_loss, train_acc, valid_loss, valid_acc))

student_net.load_state_dict(torch.load(f'./best.bin'))
params = student_net.state_dict()
encode8(params, '8_bit_best_model.pkl')
